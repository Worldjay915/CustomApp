...
import com.shijie.pojo.customapp.jpush.PushMessageActivity;
import com.shijie.pojo.customapp.manager.DialogManager;
...
import com.shijie.pojo.customapp.module.user.UserContent;
import com.shijie.pojo.customapp.network.http.RequestCenter;
import com.shijie.pojo.customapp.share.ShareManager;
import com.shijie.pojo.customapp.view.associatemail.MailBoxAssociateTokenizer;
import com.shijie.pojo.customapp.view.associatemail.MailBoxAssociateView;
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.iv_login_logo:
                ...
                ShareManager.getInstance().getUserMsg(ShareManager.PlatofrmType.WeChat, new PlatformActionListener() {
                    @Override
