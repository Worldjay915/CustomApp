...
import com.shijie.pojo.customapp.adapter.CourseCommentAdapter;
import com.shijie.pojo.customapp.manager.UserManager;
import com.shijie.pojo.customapp.module.course.BaseCourseModel;
import com.shijie.pojo.customapp.module.course.CourseCommentValue;
...
import com.shijie.pojo.customapp.view.course.CourseDetailFooterView;
import com.shijie.pojo.customapp.view.course.CourseDetailHeaderView;

/**
 * 项目名: CustomApp
 * 包名: com.shijie.pojo.customapp.activity.base
 * 创建者:  zsj
 * 创建事件: 2017/5/20 11:12
 * 描述:   课程详情Activity, 展示课程详情,这个页面要用signalTop模式
 */
