...
package com.shijie.pojo.customapp.zxing.view;
...
public final class ViewfinderView extends View {
    ...
    private static final int SPEED_DISTANCE = 5;  //蓝色条的移动加速度
    ...
    private int slideTop; //扫码框的顶部
    private int slideBottom; //扫码框的下部
