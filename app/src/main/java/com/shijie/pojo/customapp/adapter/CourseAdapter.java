...
import com.shijie.pojo.androidsdk.core.AdContextInterface;
import com.shijie.pojo.androidsdk.core.video.VideoAdContext;
import com.shijie.pojo.androidsdk.utils.Utils;
import com.shijie.pojo.customapp.R;
import com.shijie.pojo.customapp.activity.PhotoViewActivity;
...
/**
 * 项目名: CustomApp
 * 包名: com.shijie.pojo.customapp.adapter
 * 创建者:  zsj
 * 创建事件: 2017/5/12 10:13
 * 描述:  主页面适配器
 */
...
public class CourseAdapter extends BaseAdapter{
    ...
    private static final int CARD_TYPE_ONE = 0x01; //多图展示
    private static final int CARD_TYPE_TWO = 0x02;  // 单图展示
    private static final int CARD_TYPE_THREE = 0x03; // 水平广告item
        ...
        //无tag时
         ...
         switch (type){
             ...
             case CARD_TYPE_ONE:
                 ...
                 mViewHolder.mInfoView.setText(value.info.concat(mContext.getString(R.string.tian_qian)));
                 mViewHolder.mFooterView.setText(value.text);
                 mViewHolder.mPriceView.setText("...");
