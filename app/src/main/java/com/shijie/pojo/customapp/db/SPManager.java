...
package com.shijie.pojo.customapp.db;

import android.content.Context;
import android.content.SharedPreferences;
import android.content.SharedPreferences.Editor;

import com.shijie.pojo.customapp.application.BaseApplication;
...
public class SPManager {
     ...
     * Preference文件名
     */
    private static final String SHARE_PREFREENCE_NAME = "sp.pre";
