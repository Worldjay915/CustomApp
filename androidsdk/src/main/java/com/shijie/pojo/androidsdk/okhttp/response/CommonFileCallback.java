package com.shijie.pojo.androidsdk.okhttp.response;

import android.os.Handler;
import android.os.Looper;
import android.os.Message;

import com.shijie.pojo.androidsdk.okhttp.exception.OkHttpException;
import com.shijie.pojo.androidsdk.okhttp.listener.DisposeDataHandle;
import com.shijie.pojo.androidsdk.okhttp.listener.DisposeDownloadListener;
...
/**
 * 项目名: CustomApp
 * 包名: com.shijie.pojo.androidsdk.okhttp.response
 * 创建者:  zsj
 * 创建事件: 2017/5/10 16:44
 * 描述:  专门处理文件下载回调
 */
